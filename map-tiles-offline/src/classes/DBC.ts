...
export abstract class DBC {
    ...
    static MAP_DB: [{ key: string; value: DBC_Plan }] = [
        { key: DBC.DATABASE_TABLE_REL_ROUTE_TASK, value: DBC.DB_RELROUTETASK },
        { key: DBC.DATABASE_TABLE_ROUTE, value: DBC.DB_ROUTE },
        { key: DBC.DATABASE_TABLE_STATE, value: DBC.DB_STATE },
        { key: DBC.DATABASE_TABLE_TASK, value: DBC.DB_TASK },
        { key: DBC.DATABASE_TABLE_USERS, value: DBC.DB_USERS },
        { key: DBC.DATABASE_TABLE_SCORE, value: DBC.DB_SCORE }]
}