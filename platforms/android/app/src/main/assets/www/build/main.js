...
var Task = /** @class */ (function () {
    ...
    Task.prototype.getSolution = function () {
        ...
        if (this.solutionType == "vector_values" || this.solutionType == "vector_intervals") {
            return solution;
        }
        if (this.solutionType != 'multiple_choice') {
            return solution[0];
