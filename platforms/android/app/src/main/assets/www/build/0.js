...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__task_detail__ = __webpack_require__(1169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_safari_view_controller__ = __webpack_require__(1158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__task_detail_map__ = __webpack_require__(1170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_customKeyBoard_custom_keyboard__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_leaflet__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_modals_service__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_chat_and_session_service__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_photo_viewer__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__classes_Helper__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_spinner_dialog__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_images_service__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_js_levenshtein__ = __webpack_require__(1171);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__app_api_services_translation_service__ = __webpack_require__(115);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskDetail = /** @class */ (function () {
    function TaskDetail(navCtrl, navParams, ormService, modalCtrl, deepLinker, modalsService, gpsService, chatAndSessionService, app, photoViewer, spinnerDialog, imageService, cdRef, safariViewController, translationService) {
        ...
        this.inAppBrowser = new __WEBPACK_IMPORTED_MODULE_19__ionic_native_in_app_browser__["a" /* InAppBrowser */]();
        this.linkHttpsPipeFilter = new __WEBPACK_IMPORTED_MODULE_20__app_pipes_linkHttps_pipe__["a" /* LinkHttpsPipe */]();
    ...
    */
    ...
    TaskDetail.prototype.ionViewWillEnter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _i, _f, task, subtaskDetails, subtaskModal_1, subtaskModal_2, answerArray, answerArray, i, component, answerArray, i, _g, details, scorableTaskCount, _h, _j, task, scorableTaskCount, _k, _l, task, gpsType, points, buttonCount, startCharCode, i, _m, translation, isFetched;
                ...
                switch (_o.label) {
                    ...
                    case 4:
                        ...
                        if (this.task.getLegitSubtasks() && this.subTasksRequired) {
                            ...
                            for (_h = 0, _j = this.task.getLegitSubtasks(); _h < _j.length; _h++) {
                                task = _j[_h];
                        ...
                        if (this.rootTask && this.subTasksRequired && this.task.solutionType !== 'info') {
                            ...
                            for (_k = 0, _l = this.rootTask.getLegitSubtasks(); _k < _l.length; _k++) {
                                task = _l[_k];
                                if (task.solutionType != 'info') {
                                    scorableTaskCount++;
                                }
                        ...
                        return [4 /*yield*/, this.translationService.getTranslationForTask(this.taskId, this.route.code)];
                    case 5:
                        _m = _o.sent(), translation = _m.translation, isFetched = _m.isFetched;
    ...
    TaskDetail.prototype.showHint = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                needUpdate = false;
                title = "";
                type = this.translatePage ? this.translation.getHint(index).type : this.task.getHint(index).type;
                message = this.translatePage ? this.translation.getHint(index).value : this.task.getHint(index).value;
    ...
    TaskDetail.prototype.checkResult = function () {
        return __awaiter(this, void 0, void 0, function () {
            var solution, answer, details, f_answer, f_solution, taskSuccess, checkedByUser, i, item, solution_1, solutionList, von, bis, answer_1, solution_2, vonLow, bisLow, solution_3, gpsType, answers, solutions, solvedTask, detailSolutions, solutionText, i, answer_2, checkAnswer, solution_4, answers, solutions, solvedTask, detailSolutions, solutionText, i, answer_3, checkAnswer, solution_5, answers, index, answer_4, solutions, solvedTask, detailSolutions, solutionText, solutionsUsed, i, answer_5, checkAnswer, originalAnswer, solutionIndex, solutions, precision, solvedTask, detailSolutions, blankText, _loop_1, _i, _a, answer_6, answers, solution_6, solvedLow, solvedTask, detailSolutions, displaySolution;
                ...
                if (this.task.solutionType == "value") {
                    ...
                    _loop_1 = function (answer_6) {
                        ...
                        for (var _i = 0, _a = solutionObject.answers; _i < _a.length; _i++) {
                            var solution_7 = _a[_i];
                            answer_6.answer = trim(answer_6.answer);
                            var absoluteDistance = __WEBPACK_IMPORTED_MODULE_18_js_levenshtein__(solution_7.toLowerCase(), answer_6.answer.toLowerCase());
                            var relativeDistance = absoluteDistance / solution_7.length;
                    ...
                    answers = this.taskDetails.answerMultipleChoice;
                    solution_6 = this.specialSolution;
                    solvedLow = false;
                    solvedTask = +solution_6.numerator === +answers[0].answer && +solution_6.denominator === +answers[1].answer && (solution_6.mixed === "true" ? +solution_6.number === +answers[2].answer : true);
                    if (!solvedTask) {
                        solvedTask = +solution_6.numerator / +solution_6.denominator === +answers[0].answer / +answers[1].answer && (solution_6.mixed === "true" ? +solution_6.number === +answers[2].answer : true);
                        if (solvedTask) {
                            solvedLow = true;
                        }
                    }
                    detailSolutions = [{
                            ...
                            mixed: solution_6.mixed === "true",
                        }];
                    displaySolution = '' +
                        ("<span class=\"fraction-display-container " + (solution_6.mixed !== 'true' ? 'clean-fraction' : '') + "\">") +
                        (solution_6.mixed === "true" ? "<span class=\"whole-number\">" + solution_6.number + "</span>" : '') +
                        '    <ion-grid>' +
                        '         <ion-row class="first-row">' +
                        '            <ion-col>' +
                        ("                <span>" + solution_6.numerator + "</span>") +
                        '            </ion-col>' +
                        '        </ion-row>' +
                        '        <ion-row>' +
                        '            <ion-col>' +
                        ("               <span>" + solution_6.denominator + "</span>") +
                        '            </ion-col>' +
                        '        </ion-row>' +
                        '    </ion-grid>' +
                        '</span>';
    ...
    TaskDetail.prototype.taskSolved = function (solved, solution, eventSolution) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        if (this.taskDetails) {
            if (this.subTasksRequired && this.task.getLegitSubtasks() && this.task.getLegitSubtasks().length > 0) {
                ...
                if (this.solvedSubtasks.length < this.task.getLegitSubtasks().length) {
                    var subtaskCount = 0;
                    for (var _b = 0, _c = this.task.getLegitSubtasks(); _b < _c.length; _b++) {
                        var subtask = _c[_b];
                    ...
                    var _loop_2 = function (subtask) {
                        var actualTask = this_1.task.getLegitSubtasks().find(function (task) {
    ...
    TaskDetail.prototype.openSubtask = function (index) {
        ...
        if (!index && index !== 0 && this.solvedSubtasks.length === rootTask.getLegitSubtasks().length)
            return;
        if (!index && index !== 0) {
            index = this.solvedSubtasks.length;
        }
        return this.navCtrl.push(TaskDetail_1, {
            taskId: this.taskId,
    ...
    TaskDetail.prototype.displayScoreCalculation = function () {
        if (this.subTasksRequired && this.task.getLegitSubtasks() && this.task.getLegitSubtasks().length > 0) {
            var scoreModal_1 = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__modals_MCMIconModal_MCMIconModal__["a" /* MCMIconModal */], {
                type: 'text',
                ...
                buttons: [
                    {
                        title: 'a_alert_close',
                        callback: function () {
                            scoreModal_1.dismiss();
                        }
                    }
                ]
            }, { showBackdrop: true, enableBackdropDismiss: true, cssClass: this.app.activeNarrative });
            scoreModal_1.present();
        }
    };
    ...
    TaskDetail.prototype.openLinkInBrowser = function (url) {
        var _this = this;
        this.safariViewController.isAvailable()
            .then(function (available) {
            var saveUrl = _this.linkHttpsPipeFilter.transform(url);
            if (available) {
                ...
                _this.inAppBrowser.create(saveUrl, '_system', options);
            }
        });
    };
    TaskDetail.prototype.reportProblem = function () {
        var _this = this;
        var feedbackOpenFunction = function () {
            var problemReportModal = _this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_22__modals_MCMReportProblemModal_MCMReportProblemModal__["a" /* MCMReportProblemModal */], {
                taskCode: _this.task.code
            });
            problemReportModal.present();
        };
        var confirmationModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_4__modals_MCMIconModal_MCMIconModal__["a" /* MCMIconModal */], {
            type: 'text',
            title: "a_task_feedback_alert_title",
            message: "a_task_feedback_alert_text",
            modalType: __WEBPACK_IMPORTED_MODULE_5__app_app_component__["a" /* MCMModalType */].general,
            narrativeEnabled: this.route.isNarrativeEnabled(),
            narrative: this.app.activeNarrative,
            buttons: [
                {
    ...
    TaskDetail.prototype.fillBlankSolutionElement = function () {
        var _this = this;
        this.specialSolution = this.translatePage ? this.translation.solution : this.task.getSolution();
        var blankMatch;
        var blankText = this.specialSolution.val;
        var placeholderCount = [];
        while ((blankMatch = this.blankRegex.exec(blankText)) !== null) {
            var savedAnswer = this.taskDetails.answerMultipleChoice && this.taskDetails.answerMultipleChoice.length > 0 ? this.taskDetails.answerMultipleChoice.find(function (answer) {
                return answer.id === blankMatch[1] && answer.count == (placeholderCount[blankMatch[1]] ? placeholderCount[blankMatch[1]] : 0);
            }) : null;
            blankText = blankText.replace(blankMatch[0], "<span id=\"" + blankMatch[1] + "\" data-count=\"" + (placeholderCount[blankMatch[1]] ? placeholderCount[blankMatch[1]] : '0') + "\" class=\"blankInput " + ((savedAnswer && savedAnswer.solved || (this.taskDetails && (this.taskDetails.solved || this.taskDetails.solvedLow || this.taskDetails.failed))) ? "disabled" : "") + "\" role=\"textbox\" contenteditable>" + (savedAnswer ? savedAnswer.answer : "") + "</span>");
            if (!placeholderCount[blankMatch[1]]) {
        ...
        var blankContainer = document.getElementById('blankContainer_' + this.task.id);
        if (blankContainer) {
            blankContainer.innerHTML = blankText;
            var inputs = blankContainer.getElementsByClassName('blankInput');
            if (!this.taskDetails.answerMultipleChoice || this.taskDetails.answerMultipleChoice.length == 0) {
                var answers = [];
    ...
    TaskDetail.prototype.toggleTranslation = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.translationService.getTranslationForTask(this.taskId, this.route.code, true)];
                    case 1:
    ...
    TaskDetail = TaskDetail_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_21__ionic_native_safari_view_controller__["a" /* SafariViewController */],
            __WEBPACK_IMPORTED_MODULE_23__app_api_services_translation_service__["a" /* TranslationService */]])
    ], TaskDetail);
    return TaskDetail;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_leaflet__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_leaflet___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_leaflet__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet_markercluster__ = __webpack_require__(625);
