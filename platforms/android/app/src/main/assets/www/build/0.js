...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_js_levenshtein__ = __webpack_require__(1151);
...
var TaskDetail = /** @class */ (function () {
    ...
    */
    ...
    TaskDetail.prototype.ionViewWillEnter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _a, _b, _c, _d, _e, blankMatch_1, blankText, savedAnswer, blankContainer, inputs, answers, _i, _f, input, _loop_1, _g, _h, input, answerArray, i, component, answerArray, i, subtaskModal_1, thiss_1, subtaskModal_2, _j, _k, task, subtaskDetails, _l, details, scorePerQuestion, amountOfQuestions, scorableTaskCount, _m, _o, task, gpsType, points, buttonCount, startCharCode, i;
                    ...
                    case 3:
                        ...
                        if (this.task.solutionType === 'blanks') {
                            ...
                            if (!this.taskDetails.answerMultipleChoice || this.taskDetails.answerMultipleChoice.length == 0) {
                                answers = [];
                                for (_i = 0, _f = Array.from(inputs); _i < _f.length; _i++) {
                                    input = _f[_i];
                            ...
                            _loop_1 = function (input) {
                                input.addEventListener('input', function (event) {
                                    var answerElement = _this.taskDetails.answerMultipleChoice.find(function (answer) { return answer.id === input.id; });
                    ...
                    case 4:
                        ...
                        if (!this.rootTask && this.route.isAnswerFeedbackEnabled() && this.task.solutionType != 'info') {
                            if (this.task.solutionType == 'vector_values' || this.task.solutionType == 'vector_intervals') {
                                ...
                                scorePerQuestion = this.specialSolution.settings.check_type === 'strict' ? 40 : (this.specialSolution.settings.check_type === 'normal' ? 30 : 20);
                                amountOfQuestions = this.specialSolution.features.length;
    ...
    TaskDetail.prototype.checkResult = function () {
        return __awaiter(this, void 0, void 0, function () {
            var solution, answer, details, f_answer, f_solution, taskSuccess, checkedByUser, i, item, solution_1, solutionList, von, bis, answer_1, solution_2, vonLow, bisLow, solution_3, gpsType, answers, solutions, solvedTask, detailSolutions, solutionText, i, answer_2, checkAnswer, solution_4, answers, solutions, solvedTask, detailSolutions, solutionText, i, answer_3, checkAnswer, solution_5, answers, index, answer_4, solutions, solvedTask, detailSolutions, solutionText, i, answer_5, checkAnswer, originalAnswer, _i, solutions_1, solution_6, solutions, precision, solvedTask, detailSolutions, blankText, _loop_2, _a, _b, answer_6;
            return __generator(this, function (_c) {
                ...
                if (this.task.solutionType == "value") {
                    ...
                    for (i = 0; i < answers.length; i++) {
                        ...
                        for (_i = 0, solutions_1 = solutions; _i < solutions_1.length; _i++) {
                            solution_6 = solutions_1[_i];
                            if (checkAnswer > +solution_6 - 0.0001 && checkAnswer < +solution_6 + 0.0001) {
                    ...
                    for (_a = 0, _b = this.taskDetails.answerMultipleChoice; _a < _b.length; _a++) {
                        answer_6 = _b[_a];
                        _loop_2(answer_6);
                    }
                    if (solvedTask) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (!this.navParams.get('goToNextTaskById')) return [3 /*break*/, 5];
                        goToNextTaskById = this.navParams.get('goToNextTaskById');
    ...
    TaskDetail.prototype.taskSolved = function (solved, solution) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var that, message, title, that_1, bSampleSolution, subTaskOkay, bNextTask, modal_1, data, details, message, buttons, tries_1, canSkipSubtask, bShowHint, thiss_2, bShowSubtask, bClose, bSampleSolution, bSkipTask, bFailTask, title, modal_2, data, bNextTask;
            return __generator(this, function (_a) {
                that = this;
                // Add event of user entering trail when session active
